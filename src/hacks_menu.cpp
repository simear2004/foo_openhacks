...
HMENU OpenHacksMenu::GenerateMenu()
{
    ...
    {
        GenerateMenuUsingManager(menu, mFileMenuPtr, mainmenu_groups::file, L"ÎÄ¼þ", CommandFileStart);
        GenerateMenuUsingManager(menu, mEditMenuPtr, mainmenu_groups::edit, L"±à¼­", CommandEditStart);
        GenerateMenuUsingManager(menu, mViewMenuPtr, mainmenu_groups::view, L"ÊÓÍ¼", CommandViewStart);
        GenerateMenuUsingManager(menu, mPlaybackMenuPtr, mainmenu_groups::playback, L"²¥·Å", CommandPlaybackStart);
        GenerateMenuUsingManager(menu, mLibraryMenuPtr, mainmenu_groups::library, L"Ã½Ìå¿â", CommandLibraryStart);
        GenerateMenuUsingManager(menu, mHelpMenuPtr, mainmenu_groups::help, L"°ïÖú", CommandHelpStart);
